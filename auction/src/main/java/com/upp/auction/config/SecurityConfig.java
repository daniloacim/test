package com.upp.auction.config;
...
import com.upp.auction.user.UserDetailsServiceImpl;
	...
	public void configure(WebSecurity web) throws Exception {
		...
		web.ignoring()
				.antMatchers("/", "/index.html", "/app/**", "/registration", "/login","/registration/activateProcess","/registration/**", 
						"/favicon.ico", "/confirm_registration*", "/category","/registration/firm/*","/order/acceptLess","/order/test");
	}
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.cors().and()
				...
				.authorizeRequests().antMatchers("/login", "/registration","/registration/**", "/registration/activateProcess",
						"/confirm_registration*", "/category", "/registration/firm/*","/order/acceptLess","/order/test").permitAll()
